...
public class AppTheme {
    ...
    public AppTheme(Context context, boolean noActionBar) {
        ...
        theme = PreferenceManager.getDefaultSharedPreferences(context).getString("pref_theme", "light");
        color = PreferenceManager.getDefaultSharedPreferences(context).getInt("pref_theme_colorPrimary", R.color.md_red_500);
        dark = PreferenceManager.getDefaultSharedPreferences(context).getBoolean("pref_dark_theme", false);
        headerCustom = PreferenceManager.getDefaultSharedPreferences(context).getBoolean("pref_theme_header", true);
